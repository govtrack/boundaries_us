# Definition file for DC Advisory Neighborhood Commissions and
...
# PYTHONPATH=data/shapefiles/ ./manage.py create-layer dc-anc-2013 dc-anc-2013 dc_smd_2013.definition.anc_colorer
